module vhey_marketplace::marketplace {
    use std::signer;
    ...
    public entry fun list(
        ...
        let listing = object::object_from_constructor_ref<Listing>(&constructor_ref);
        let listing_address = object::object_address(&listing);
        let token_address = object::object_address(&token);
        let extend_ref = object::generate_extend_ref(&constructor_ref);
        let delete_ref = object::generate_delete_ref(&constructor_ref);

        object::transfer<Token>(seller, token, listing_address);
    ...
    public entry fun buy(
        ...
        object::transfer<Token>(&listing_signer, listing_ref.token, buyer_address);
    ...
    public entry fun delist(
        ...
        let listing_signer = object::generate_signer_for_extending(&listing_ref.extend_ref);
        object::transfer<Token>(&listing_signer, listing_ref.token, seller_address);
